...
<div class="container">
    	...
    	<form action="${pageContext.request.contextPath }/productUpdate" id="tab3" enctype="multipart/form-data" method="post">
             <input type="hidden" name="pro_id" value="${pro.pro_id }">
            
            <label>Name</label>
            <input value="${pro.pro_name }" name="pro_name" type="text" class="input-xlarge"/>
             <label>Description</label>
            <textarea value="${pro.pro_description }" name="pro_description" rows="3" class="input-xlarge"></textarea> 
            <label>Stock</label>
            <input value="${pro.pro_stock }" name="pro_stock" type="number" class="input-xlarge"/>
            <label>Price</label>
            <input value="${pro.pro_price }" name="pro_price" type="text" class="input-xlarge"/>
            ...
            <table>
            	<tr>
            		...
            		<td>
						...
						<option value="${pro.pro_category.cat_name }"" label="----------- Select Category -----------" disabled="true" selected/>
